...
do
    folder=${folder%".txt"}
	echo "${green}Running our treewidth-based approach for computing Markov Decision Process Discounted Sums of Rewards on benchmark --------> $folder ${reset}"
	...
	do
		...
		./${path}build/mdp-discsum mcs-$folder/$file > mcs-$folder/$file.log
